# pytho290 <img src="assets/logo_lorem_ipsum.png" align="right" width="200" style="border-radius: 15px;" alt="pytho290">
...
![Open Issues](https://img.shields.io/github/issues/ci-bot/${PROJECT_SLUG})
...
```bash
git clone https://github.com/ci-bot/${PROJECT_SLUG}.git
cd ${PROJECT_SLUG}
...
## 👨‍💻 Authors
- ${AUTHOR_NAME} — [GitHub](https://github.com/ci-bot) | [LinkedIn](${LINKEDIN_URL})
...
## 🔗 Useful Links
- [GitHub Repository](https://github.com/ci-bot/${PROJECT_SLUG})
- [Issue Tracker](https://github.com/ci-bot/${PROJECT_SLUG}/issues)
