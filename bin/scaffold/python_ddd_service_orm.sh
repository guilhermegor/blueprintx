...
create_python_files() {
    ...
    cp -r "$BLUEPRINTX_ROOT/templates/ddd-service-orm-db/src/." "$project_path/src"
...
copy_common_templates() {
	...
	scaffold_copy_common_templates "ddd-service-orm-db" "$1"
}
...
copy_mkdocs_templates() {
    ...
    cp "$BLUEPRINTX_ROOT/templates/ddd-service-orm-db/docs/api/index.md" \
        "$project_path/docs/api/index.md"
    cp "$BLUEPRINTX_ROOT/templates/ddd-service-orm-db/docs/api/reference.md" \
...
main() {
    ...
    print_section "Python ddd-service-orm-db scaffold"
