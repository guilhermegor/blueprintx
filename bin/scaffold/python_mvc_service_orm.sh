...
# shellcheck source=bin/lib/scaffold_common.sh
source "$SCRIPT_DIR/../lib/scaffold_common.sh"
...
copy_common_templates() {
	...
	# scaffolds except for the tier name, twice. It lives in bin/lib/scaffold_common.sh
...
copy_mkdocs_templates() {
    ...
    envsubst '${PROJECT_DISPLAY_NAME}' \
        < "$BLUEPRINTX_ROOT/templates/mvc-service-orm-db/docs/index.md" \
        > "$project_path/docs/index.md"
    cp "$BLUEPRINTX_ROOT/templates/mvc-service-orm-db/docs/architecture.md" \
    ...
    cp "$BLUEPRINTX_ROOT/templates/mvc-service-orm-db/docs/api/index.md" \
        "$project_path/docs/api/index.md"
    cp "$BLUEPRINTX_ROOT/templates/mvc-service-orm-db/docs/api/reference.md" \
...
main() {
    ...
    print_section "Python mvc-service-orm-db scaffold"
