...
Scope of this file: rules that apply specifically to `application/`.
Layer import boundaries, capability flow, and high-level `factories.ts`
rules live in the parent `templates/react-spa-webpack/CLAUDE.md` — do
