...
Config owns SQL **text**; an infrastructure adapter owns its **execution**. This module
stays on the text side of that border: it opens no handler and runs no statement.
"""
...
from chassis.db_schema.application.database_factory import active_backend
from chassis.typing import type_checker
from utils.queries import load_query as _load_query_from


# Anchored to this module, never to the working directory — a service launched from cron,
