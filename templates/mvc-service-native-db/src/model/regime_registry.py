"""Resolve a period to the schema regime that owns it.

Part of the per-regime adapter pattern (issue #148). See :mod:`model.regime_window` for
what one regime window is; this registry is the lookup across every known regime.
"""
